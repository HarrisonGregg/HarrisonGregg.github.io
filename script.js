...
.controller('HomeController', function($scope) {
    ...
    $scope.projects = [
    	...
    	{title: 'This Website', 		image:'', 		color: 'rgb(100, 47, 53)', url: 'this-site',		body: 'I made this website using AngualarJS.'},
    	...
    	{title: 'Neural Net', 			image:'', 		color: 'rgb(100, 47, 53)', url: 'neural-net',		body: 'These are the things that I did with a neural net for my Artificial Intelligence class.'},
    	{title: 'Curve Editor', 		image:'', 		color: 'rgb(30, 47, 100)', url: 'curve-editor',	body: 'This is a project for my Computer Graphics class.'},
    	{title: 'Ray Tracer', 			image:'', 		color: 'rgb(100, 30, 100)', url: 'ray-tracer', 		body: 'This is a project for my Computer Graphics class.'},
    	{title: 'Synthepyzer', 			image:'', 		color: 'rgb(100, 47, 53)', url: 'synthepyzer', 	body: 'This is a Python program that I made with my friends for HackPrinceton Fall 2013.'},
